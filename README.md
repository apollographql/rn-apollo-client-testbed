...
### Using the VSCode "Apollo GraphQL" extension

This application is already prepared for this, so you just need to install the [Apollo GraphQL VSCode extension](https://marketplace.visualstudio.com/items?itemName=apollographql.vscode-apollo) and enable the [Apollographql > Dev Tools: Show Panel](vscode://settings/apollographql.devTools.showPanel) setting.

For more details, see https://www.apollographql.com/docs/react/development-testing/developer-tooling#apollo-client-devtools-in-vs-code
